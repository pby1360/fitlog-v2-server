...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/members/**", "/api/workout/**", "/api/workout-programs/**", "/api/workoutroutine/**", "/api/workout-sessions/**").authenticated() // [수정] 인증 필요 경로 명시
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "http://localhost:5173", "https://fitlog-v2-web.vercel.app"));
